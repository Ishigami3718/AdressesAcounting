...
![697](resources/ERD.png)
![](resources/Variant1.png)
Записи для історії адрес через рядок, при оновлені адрес(хоч ручному хоч при розділені або злитті вулиць). В цьому випадку не потрібна уся інформація про минулі назви вулиці до якої відносилась адреса, нас цікавить лише до якої вулиці належала адреса у певний момент часу, і для цього достатньо її назви. Питання в тому чи не є це порушенням 3НФ і чи не краще наступний варіант:
![697](resources/Variant2.png)
В цьому випадку запис прив'язаний до конкретної неактивної вулиці, що з точки зору зв'язків правильніше і це не буде порушенням 3НФ 100%, але запити які передбачали б знаходження минулих імен вулиці якій належала адреса, не передбачаються і мають мало сенсу, тому прив'язка до вулиці у випадку темпорального запису виглядає надлишковою.
Питання в тому який варіант правильніший.
```
